...
use crate::types::{LogLevel, MintAccountAssertion};
...
impl AssertMintAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&AssertMintAccountInstructionData::new()).unwrap();
...
impl Default for AssertMintAccountInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
