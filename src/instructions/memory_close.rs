...
pub struct MemoryClose {
    ...
    /// Memory account
    pub memory: solana_pubkey::Pubkey,
}

impl MemoryClose {
    pub fn instruction(&self, args: MemoryCloseInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.memory, false));
        accounts.extend_from_slice(remaining_accounts);
        let mut data = borsh::to_vec(&MemoryCloseInstructionData::new()).unwrap();
...
pub struct MemoryCloseBuilder {
    ...
    memory: Option<solana_pubkey::Pubkey>,
    memory_id: Option<u8>,
...
impl MemoryCloseBuilder {
    ...
    /// Memory account
    #[inline(always)]
    pub fn memory(&mut self, memory: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct MemoryCloseCpiAccounts<'a, 'b> {
    ...
    /// Memory account
    pub memory: &'b solana_account_info::AccountInfo<'a>,
}
...
impl<'a, 'b> MemoryCloseCpiBuilder<'a, 'b> {
    ...
    /// Memory account
    #[inline(always)]
    pub fn memory(&mut self, memory: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
struct MemoryCloseCpiBuilderInstruction<'a, 'b> {
    ...
    memory: Option<&'b solana_account_info::AccountInfo<'a>>,
    memory_id: Option<u8>,
    memory_bump: Option<u8>,
