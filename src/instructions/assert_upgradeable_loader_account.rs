...
use crate::types::{LogLevel, UpgradeableLoaderStateAssertion};
...
impl AssertUpgradeableLoaderAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&AssertUpgradeableLoaderAccountInstructionData::new()).unwrap();
...
pub struct AssertUpgradeableLoaderAccountInstructionData {
    discriminator: u8,
}
...
impl Default for AssertUpgradeableLoaderAccountInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
