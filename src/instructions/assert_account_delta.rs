...
use crate::types::{AccountDeltaAssertion, LogLevel};
...
pub struct AssertAccountDelta {
    ...
    pub account_a: solana_pubkey::Pubkey,
    /// Account B where the delta is calculated to
    pub account_b: solana_pubkey::Pubkey,
}
...
pub struct AssertAccountDeltaBuilder {
    account_a: Option<solana_pubkey::Pubkey>,
    account_b: Option<solana_pubkey::Pubkey>,
...
impl AssertAccountDeltaBuilder {
    ...
    /// Account A where the delta is calculated from
    #[inline(always)]
    pub fn account_a(&mut self, account_a: solana_pubkey::Pubkey) -> &mut Self {
        self.account_a = Some(account_a);
        self
    }
    /// Account B where the delta is calculated to
    #[inline(always)]
    pub fn account_b(&mut self, account_b: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct AssertAccountDeltaCpiAccounts<'a, 'b> {
    /// Account A where the delta is calculated from
    pub account_a: &'b solana_account_info::AccountInfo<'a>,
    /// Account B where the delta is calculated to
    pub account_b: &'b solana_account_info::AccountInfo<'a>,
}
...
impl<'a, 'b> AssertAccountDeltaCpiBuilder<'a, 'b> {
    ...
    /// Account A where the delta is calculated from
    #[inline(always)]
    pub fn account_a(&mut self, account_a: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
        self.instruction.account_a = Some(account_a);
        self
    }
    /// Account B where the delta is calculated to
    #[inline(always)]
    pub fn account_b(&mut self, account_b: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
struct AssertAccountDeltaCpiBuilderInstruction<'a, 'b> {
    ...
    account_a: Option<&'b solana_account_info::AccountInfo<'a>>,
    account_b: Option<&'b solana_account_info::AccountInfo<'a>>,
    log_level: Option<LogLevel>,
    assertion: Option<AccountDeltaAssertion>,
