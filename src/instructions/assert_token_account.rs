...
use crate::types::{LogLevel, TokenAccountAssertion};
...
impl AssertTokenAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&AssertTokenAccountInstructionData::new()).unwrap();
...
impl Default for AssertTokenAccountInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
